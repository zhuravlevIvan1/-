...
questions_list.append(
        Question('Какое животное не фигурирует в китайском зодиаке?', 'Колибри', 'Кролик', 'Собака', 'Дракон'))
questions_list.append(
        Question('Какая самая редкая группа крови?', 'IV группа', ' I группа', 'II группа', 'III группа'))
questions_list.append(
        Question('Сколько костей в теле человека?', '206', '158', '100', '285'))
questions_list.append(
        Question('Какая социальная сеть появилась в 2003 году?', 'Myspace', 'Facebook', 'Twitter', 'VK'))
questions_list.append(
        Question('Какая страна потребляет больше всего шоколада?', 'Швейцария', 'Северная Америка', 'Германия', 'Испания'))
app = QApplication([])
